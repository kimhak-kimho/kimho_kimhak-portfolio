...
const workGallery = [
  ...
  },
  {
    ...
    description: 'Managed and maintained student enrollment records, ensuring accurate registration, status updates, and academic information.',
  },
  {
    id: 5,
    src: workphoto05,
    ...
    description: 'Analyzed student enrollment and academic data to identify trends and support data-driven decision making.',
  },
  {
    id: 6,
    src: workphoto06,
